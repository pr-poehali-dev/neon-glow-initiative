...
const services = [
  {
    title: "Услуги Авитолога",
    description:
      "Создаю и оптимизирую объявления на Авито: правильные заголовки, описания, фото и категории. Ваши объявления будут в топе и приводить целевых клиентов.",
    mockup: "social",
  },
  {
    title: "Яндекс.Директ",
    description:
      "Настраиваю контекстную рекламу в Яндекс.Директ: подбор ключевых слов, создание объявлений, оптимизация ставок. Платите только за реальные клики.",
    mockup: "google-ads",
  },
  {
    title: "Яндекс.Бизнес",
    description: "Настраиваю и веду профиль в Яндекс.Бизнес: оформление карточки, отзывы, акции и автоматическая реклама на картах и поиске.",
    mockup: "email",
  },
  {
    title: "Аудит рекламы",
    description:
      "Анализирую ваши текущие кампании и объявления, нахожу точки роста. Покажу, где вы теряете деньги и как исправить за 24 часа.",
    mockup: "seo",
  },
  {
    title: "Аналитика и отчёты",
    description:
      "Еженедельные отчёты по всем каналам: стоимость заявки, конверсии, ROI. Прозрачная работа — вы всегда видите за что платите.",
    mockup: "analytics",
  },
  {
    title: "Комплексное ведение",
    description:
      "Беру на себя все рекламные каналы: Авито + Яндекс.Директ + Яндекс.Бизнес. Единый специалист — максимум синергии и экономия бюджета.",
    mockup: "web-dev",
    badges: [
      { icon: <Shield className="w-4 h-4" />, text: "Без переплат" },
      { icon: <DollarSign className="w-4 h-4" />, text: "Фикс. оплата" },
      { icon: <CheckCircle className="w-4 h-4" />, text: "Гарантия ROI" },
    ],
  },
]
  ...
  return (
    <section id="services" className="py-24 bg-black relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6">Что я делаю для вас</h2>
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            Реклама на трёх платформах под ключ — от настройки до ежемесячных отчётов.
          </p>
        </motion.div>
