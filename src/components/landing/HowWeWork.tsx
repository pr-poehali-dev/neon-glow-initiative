...
const steps = [
  {
    number: "01",
    title: "Разбор задачи",
    description: "Изучаю ваш бизнес, конкурентов и целевую аудиторию. Определяем лучшие каналы и согласовываем стратегию.",
  ...
  },
  {
    ...
    description: "Создаю объявления, кампании и настраиваю таргетинг. Всё проверяется перед запуском — без слива бюджета.",
  ...
  },
  {
    ...
    description: "Запускаем, смотрим результаты, докручиваем. Еженедельные отчёты — вы всегда в курсе что происходит.",
  ...
  return (
    <section className="py-24 bg-black relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6">Как я работаю</h2>
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            Простой процесс — от первого звонка до потока заявок.
          </p>
        </motion.div>
